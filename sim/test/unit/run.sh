...
TESTS="$HERE/main.c $HERE/test_tilemath.c $HERE/test_tilesrc.c $HERE/test_route.c $HERE/test_atmosphere.c $HERE/test_mat4.c $HERE/test_chunkmesh_ecef.c $HERE/test_style.c $HERE/test_lru.c $HERE/test_prefetch.c $HERE/test_draw.c $HERE/test_w3atmo.c $HERE/test_camera.c $HERE/test_stars.c $HERE/test_tilemap.c $HERE/test_geo_ecef.c $HERE/test_terrain_ecef.c"
