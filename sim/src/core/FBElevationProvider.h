 ...
 * polls until the sentinel stops coming back. doc/flightbox/core.md, Abschnitt 9. */
#ifndef FBELEVATIONPROVIDER_H
#define FBELEVATIONPROVIDER_H

namespace FlightBox {

/* Matches fb_stream_ground's convention, so FBTilesElevation is a pure pass-through. The two
