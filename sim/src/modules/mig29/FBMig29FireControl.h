 ...
 *     added to FBState;
 *   - there is NO air-to-ground solution here. The 9-12 carries no guided air-to-ground weapon at all
 *     (§1) and its unguided delivery is a director the pilot flies rather than a release moment he
 *     reacts to (§5.3) — publishing a CCIP/CCRP block would be claiming a computation this jet does
 *     not make;
