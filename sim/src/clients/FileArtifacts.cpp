...
bool FileArtifacts::Png(const std::string &name, const uint8_t *rgba, int width, int height) {
...
bool FileArtifacts::Bytes(const std::string &name, const void *data, size_t bytes) {
...
bool FileArtifacts::Text(const std::string &name, const std::string &text) {
