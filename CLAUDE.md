...
**An instrument's domain is part of its claim.** A number that is right about a smaller thing than the
sentence it appears in has cost this project three rounds. State the domain beside the number.
...
| this file | the vision, the diagram, the constraints, the stance, the setup. **At most 100 lines of prose — the diagram does not count against it**, because it is the most important thing here |
