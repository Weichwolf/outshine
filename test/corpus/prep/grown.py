...
library and runs `test/corpus/GrowPart.cpp` over it -- exactly as it locates and runs Blender. It is
...
REPOSITORY = os.path.dirname(os.path.dirname(os.path.dirname(_HERE)))
SOURCE = os.path.join(REPOSITORY, "test", "corpus", "GrowPart.cpp")
