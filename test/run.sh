...
LayerIncludes() {
  case "$1" in
    ...
    tools/driver) printf '%s' "-Iinclude -Isrc/core -Isrc/core/io -Isrc/clients -Isrc/corridor -Isrc/data -Isrc/physics -Isrc/pilot -Isrc/world -Isrc/world/tiles -Itools/host -Itools/driver/parts" ;;
    *) return 1 ;;
  esac
}
