...
LayerGroups() {
  case "$(TestProfile "$1")" in
    ...
    profile/engine) printf '%s' "src/base src/base/math src/base/geo src/base/format src/base/spatial src/content/shade src/content/impostor src/world/weather src/world/sky src/base/io src/import src/import/surface src/render/plan src/render/draw src/render/impostor src/render/scene src/render src/render/device src/render/stages src/world/entity src/ui src/world/data src/world/ground src/world/ground/tiles src/generators/base src/generators/building src/generators/flora src/generators/road src/generators/terrain src/generators/water src/generators src/base/curve src/actor/body src/host src/engine/Asset.cpp src/engine/Overlay.cpp src/engine/Live.cpp src/engine/Laying.cpp src/engine/Asking.cpp src/engine/Telling.cpp src/engine/AudioOcclusion.cpp src/engine/Framing.cpp src/engine/Declaring.cpp src/engine/Keeping.cpp src/engine/Advancing.cpp src/engine/Inspection.cpp src/engine/TilePieces.cpp src/engine/HeightSheets.cpp src/engine/HeightSheetsRefinement.cpp src/engine/streaming src/engine/Engine.cpp src/engine/ImpostorPreparation.cpp src/engine/CrownPieces.cpp src/engine/WorldCrowns.cpp src/audio src/scenario/Tables.cpp src/scenario/ScenarioRead.cpp src/scenario/ReadScenarioOsm.cpp src/scenario/ScenarioWrite.cpp src/scenario/ScenarioLayer.cpp src/scenario/Views.cpp src/scenario/InputMap.cpp src/scenario/Triggers.cpp src/engine/InputPump.cpp src/engine/Assembly.cpp src/engine/SimulationState.cpp" ;;
    harness/geographiclib/geodesic | harness/khronos/validator) printf '%s' "src/base src/base/math src/base/geo src/base/format src/base/spatial src/content/shade src/content/impostor src/world/weather src/world/sky src/base/io src/import src/import/surface src/render/plan src/render/draw src/render/impostor src/render/scene src/render src/render/device src/render/stages src/world/entity src/ui src/world/data src/world/ground src/world/ground/tiles src/generators/base src/generators/building src/generators/flora src/generators/road src/generators/terrain src/generators/water src/generators src/base/curve src/actor/body src/host src/engine/Asset.cpp src/engine/Overlay.cpp src/engine/Live.cpp src/engine/Laying.cpp src/engine/Asking.cpp src/engine/Telling.cpp src/engine/AudioOcclusion.cpp src/engine/Framing.cpp src/engine/Declaring.cpp src/engine/Keeping.cpp src/engine/Advancing.cpp src/engine/Inspection.cpp src/engine/TilePieces.cpp src/engine/HeightSheets.cpp src/engine/HeightSheetsRefinement.cpp src/engine/streaming src/engine/Engine.cpp src/engine/ImpostorPreparation.cpp src/engine/CrownPieces.cpp src/engine/WorldCrowns.cpp src/audio src/scenario/Tables.cpp src/scenario/ScenarioRead.cpp src/scenario/ReadScenarioOsm.cpp src/scenario/ScenarioWrite.cpp src/scenario/ScenarioLayer.cpp src/scenario/Views.cpp src/scenario/InputMap.cpp src/scenario/Triggers.cpp src/engine/InputPump.cpp src/engine/Assembly.cpp src/engine/SimulationState.cpp" ;;
    *) return 1 ;;
  esac
}
