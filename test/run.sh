...
LayerGroups() {
  case "$1" in
    ...
    tools/driver) printf '%s' "src/core src/core/io src/gltf src/corridor src/physics src/pilot src/data src/world/tiles src/world src/sim src/scenario/ScenarioRead.cpp" ;;
