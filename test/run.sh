...
LayerIncludes() {
  case "$1" in
    ...
    unit/clients) printf '%s' "-Iinclude -Iinclude/outshine -Isrc/core -Isrc/corridor -Isrc/physics -Isrc/pilot -Isrc/scenario -Isrc/clients" ;;
    ...
    tools/driver/stills | tools/driver/window) printf '%s' "-Iinclude -Isrc/core -Isrc/core/io -Isrc/clients -Isrc/corridor -Isrc/data -Isrc/gltf -Isrc/physics -Isrc/pilot -Isrc/render -Isrc/render/plan -Isrc/render/draw -Isrc/render/stages -Isrc/scenario -Isrc/ui -Isrc/world -Isrc/world/tiles -Itools/host -Isrc/sim" ;;
    tools/driver) printf '%s' "-Iinclude -Isrc/core -Isrc/core/io -Isrc/corridor -Isrc/data -Isrc/physics -Isrc/pilot -Isrc/gltf -Isrc/scenario -Isrc/world -Isrc/world/tiles -Itools/host -Isrc/sim" ;;
    *) return 1 ;;
  esac
}
...
LayerGroups() {
  case "$1" in
    ...
    unit/clients) printf '%s' "src/core src/corridor src/physics src/pilot src/scene src/clients/Image.cpp src/scenario/ScenarioRead.cpp src/clients/Assembly.cpp" ;;
    ...
    tools/driver/stills | tools/driver/window) printf '%s' "src/core src/core/io src/gltf src/render/plan src/render/draw src/render src/render/stages src/ui src/corridor src/physics src/pilot src/data src/world/tiles src/world src/clients/GltfStudio.cpp src/clients/Image.cpp src/clients/Surfaces.cpp src/clients/Live.cpp src/scenario/ScenarioRead.cpp src/sim/Rigging.cpp src/sim" ;;
    tools/driver) printf '%s' "src/core src/core/io src/gltf src/corridor src/physics src/pilot src/data src/world/tiles src/world src/sim src/scenario/ScenarioRead.cpp src/sim/Rigging.cpp" ;;
...
GroupIncludes() {
  case "$1" in
    ...
    src/sim) printf '%s' "-Iinclude -Iinclude/outshine -Isrc/core -Isrc/core/io -Isrc/corridor -Isrc/data -Isrc/physics -Isrc/pilot -Isrc/scenario -Isrc/sim -Isrc/world -Isrc/world/tiles" ;;
