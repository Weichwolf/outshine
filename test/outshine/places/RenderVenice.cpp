...
// Venice -- A PLACE, RENDERED. This is not a proof and it scores nothing.
//
...
//   The lagoon and the island. Relief is metres, so this place tests the FLAT case: a ring that
//   only looks right over a canyon is a ring that hides its errors under the terrain.
...
int main(void) {
  ...
  for (const outshine::Measure &held : engine.measures()) {
    if (held.What.rfind("zoom ", 0) == 0 || held.What.rfind("mesh jobs", 0) == 0 ||
        ...
        held.What.rfind("jobs waiting", 0) == 0 || held.What.rfind("mesh jobs it dropped", 0) == 0 || held.What.rfind("solid:", 0) == 0 || held.What.rfind("relief:", 0) == 0 || held.What.rfind("lighting:", 0) == 0 || held.What.rfind("generators:", 0) == 0 || held.What.rfind("buildings:", 0) == 0 || held.What.rfind("streets:", 0) == 0 || held.What.rfind("water:", 0) == 0 || held.What.rfind("the ring's vertices a land", 0) == 0 ||
