 ...
 * mapping at all.
 *
 * WHY IT IS CHECKED HERE AND NOT ONLY BY `test/khronos/glTF`. A render case notices the loss only where its
 ...
 * `test/khronos/glTF/SurfaceIdentity.h`: the names are held against the glTF's own materials there, per
