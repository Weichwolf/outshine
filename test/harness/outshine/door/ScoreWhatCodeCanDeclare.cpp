...
[[nodiscard]] outshine::Scenario ByHand(void) {
  ...
  f31.Driven.push_back(outshine::Drive{outshine::Drives::Effort, false, 400.0, 3.08, 0.0});
  f31.Driven.push_back(outshine::Drive{outshine::Drives::Effort, true, 5500.0, 1.0, 0.0});
  f31.Driven.push_back(outshine::Drive{outshine::Drives::Motion, false, 0.0, 1.0, 11.3});
