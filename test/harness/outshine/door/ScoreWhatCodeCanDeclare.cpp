...
[[nodiscard]] outshine::Scenario ByHand(void) {
  ...
  f31.Actuators.push_back(outshine::Actuator{outshine::Actuates::Torque, false, 400.0, 3.08, 0.0});
  f31.Actuators.push_back(outshine::Actuator{outshine::Actuates::Torque, true, 5500.0, 1.0, 0.0});
  f31.Actuators.push_back(outshine::Actuator{outshine::Actuates::Steer, false, 0.0, 1.0, 11.3});
