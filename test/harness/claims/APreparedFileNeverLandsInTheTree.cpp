...
/* THE DECLARATIVE SUITES, AND THEY ARE THE WHOLE POPULATION. `test/unit/` and the rest hold
...
const char *const kCaseTrees[] = {"test/render/khronos/glTF", "test/render/outshine/grown"};
