...
constexpr Subject kSubjects[] = {
    {"water-bottle", "test/render/materials/water-bottle/scene.glb"},
    {"normal-tangent-mirror", "test/render/materials/normal-tangent-mirror/NormalTangentMirrorTest.gltf"},
    {"normal-tangent", "test/render/materials/normal-tangent/NormalTangentTest.gltf"},
    {"scifi-helmet", "test/render/materials/scifi-helmet/scene.gltf"},
    {"a-beautiful-game", "test/render/materials/a-beautiful-game/scene.gltf"},
};
