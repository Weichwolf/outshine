...
const char *const kMirror = "test/render/materials/normal-tangent-mirror/";
const char *const kGenerated = "test/render/materials/normal-tangent/";
...
const char *const kUnmapped = "test/render/texture/simple-texture/";
