 ...
 * applied to negatively-scaled meshes"* -- and `test/render/coverage/negative-scale/` decides that
...
const char *const kAsset = "test/render/coverage/negative-scale/scene.gltf";
