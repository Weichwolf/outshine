...
int main() {
  ...
  Covers("I.72 a texture reference resolves to the uv set it names, and a set the subject or the engine does not carry is a refusal quoting both the set asked for and what is bound");
