...
`mods/f16/src/missions/o4-*.fbm`,
`mods/f16/src/missions/o1-*.fbm`, `mods/f16/src/missions/o5-*.fbm`, `mods/f16/src/missions/o2-*.fbm`, `mods/f16/src/missions/w5-*.fbm`,
`mods/f16/src/missions/w3-*.fbm`, `mods/f16/src/missions/w4-*.fbm`, `mods/f16/src/missions/o3-*.fbm`, `mods/f16/src/missions/w1-*.fbm` and
`mods/f16/src/missions/w2-*.fbm` with their ten `.fbc` files
...
| ~~`C0`~~ | **CLOSED 2026-07-28.** The `.fbc` file, the three carried facts and the aggregating runner are built — [`../missions/campaign.md`](../missions/campaign.md), driven by `fb-gym --campaign`. Both determinism criteria measured on both ground bases: 9 runs one campaign fingerprint, and all 4 steps of `mods/f16/src/campaigns/viper-attrition.fbc` reproduce standalone from their state file plus the ground the run recorded | — | — | a sequence of missions is now a campaign. What is NOT closed: the ten campaigns still have no `.fbm` files, damage and fuel stay refused with a reason, and there is no campaign-scope objective |
...
[`../missions/verdict.md`](../missions/verdict.md). `mods/f16/src/missions/qra-identify.fbm` is the shape both
