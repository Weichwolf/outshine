#ifndef OUTSHINE_GENERATORS_BUILDING_BUILDINGS_H
#define OUTSHINE_GENERATORS_BUILDING_BUILDINGS_H
...
public:
  ...
  [[nodiscard]] std::string_view Called() const noexcept override { return "building"; }
