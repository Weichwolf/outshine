...
/* Opens the pool and the oracle over it. The pool's threads are running when this returns. The
 * registry and the transport are the caller's and outlive the stream. */
