...
void TransmittanceStage::Configure(const Gpu &gpu, wgpu::TextureView transLutView) {
...
void TransmittanceStage::EncodeCompute(const FrameContext &, wgpu::ComputePassEncoder &pass) {
