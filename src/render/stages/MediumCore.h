...
static inline float mediumGroundReach(MEDIUM_CONST Medium &medium, float radiusKm, float cosZenith) {
  float under = radiusKm * radiusKm * (cosZenith * cosZenith - 1.0) +
...
static inline float mediumHeightAlong(MEDIUM_CONST Medium &medium, float radiusKm, float cosZenith,
                                      float alongKm) {
...
static inline void mediumTransmittanceParams(MEDIUM_CONST Medium &medium, float u, float v,
                                             MEDIUM_THREAD float &radiusKm, MEDIUM_THREAD float &cosZenith) {
...
static inline void skyViewParams(MEDIUM_CONST Medium &medium, float radiusKm, float unitU, float unitV,
                                 float widthPx, float heightPx, MEDIUM_THREAD float &cosView,
