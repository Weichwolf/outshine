...
inline constexpr ResourceRow kResources[] = {
    ...
    {Resource::AtmosphereUniform,
     ...
     TexelFormat::Handle,
     "atmosphere"},
    {Resource::CascadeUniform,
     ResourceKind::Given,
     FallbackKind::None,
     kNoEdge,
     TexelFormat::Handle,
     "cascades"},
    {Resource::VegetationTable,
     ResourceKind::Given,
     FallbackKind::None,
     kNoEdge,
     TexelFormat::Handle,
    ...
    {Resource::ClusterJobs,
     ...
     TexelFormat::Table,
     "clusterJobs",
     4u * (uint32_t)sizeof(uint32_t)},
    {Resource::ClusterBatches,
     ResourceKind::Given,
     FallbackKind::None,
     kNoEdge,
     TexelFormat::Table,
     "clusterBatches",
     2u * (uint32_t)sizeof(uint32_t)},
    ...
    {Resource::DrawArguments,
     ...
     TexelFormat::Table,
     "drawArguments",
     (uint32_t)sizeof(SDL_GPUIndexedIndirectDrawCommand)},
};
...
inline constexpr StageRow kStages[] = {
    {Stage::MediumTransmittance,
     ...
     "mediumTransmittance",
     {kNoEdge},
     {Resource::TransmittanceLut, kNoEdge},
     {kNoEdge},
     kNoFusion},
    {Stage::MediumMultiScatter,
     ...
     "mediumMultiScatter",
     {Resource::TransmittanceLut, kNoEdge},
     {Resource::MultiScatterLut, kNoEdge},
     {kNoEdge},
     kNoFusion},
    ...
    {Stage::Irradiance,
     ...
     {Resource::SkyViewLut,
      ...
      Resource::AtmosphereUniform,
      kNoEdge},
     {Resource::IrradianceBuffer, kNoEdge},
     {kNoEdge},
     kNoFusion},
    {Stage::AutoExposure,
     Provenance::Content,
    ...
    {Stage::SubjectScan,
     ...
     PassKind::Compute,
     "subjectScan",
     {Resource::ClusterKept, Resource::ClusterBatches, kNoEdge},
     {Resource::ClusterSlot, Resource::DrawArguments, kNoEdge},
     {kNoEdge},
     kNoFusion},
    ...
    {Stage::LightVisibility,
     ...
     {kNoEdge},
     {kNoEdge},
     {Resource::ShadowAtlas, kNoEdge},
     kNoFusion},
    {Stage::Sky,
     Provenance::Content,
     PassKind::Raster,
     "sky",
     {Resource::SkyViewLut, Resource::LutSampler, Resource::AtmosphereUniform, kNoEdge},
     {kNoEdge},
     {Resource::SceneHdr, Resource::SceneVelocity, Resource::SceneDepth, kNoEdge},
     kNoFusion},
    {Stage::Sun,
     Provenance::Content,
     PassKind::Raster,
    ...
    {Stage::Moon,
     ...
     PassKind::Raster,
     "moon",
     {Resource::LutSampler, Resource::AtmosphereUniform, kNoEdge},
     {kNoEdge},
     {Resource::SceneHdr, Resource::SceneVelocity, Resource::SceneDepth, kNoEdge},
     kNoFusion},
    {Stage::Stars,
    ...
    {Stage::SubjectsTransmissive,
     Provenance::Content,
     PassKind::Raster,
     "subjectsTransmissive",
     {Resource::SceneHdr, Resource::LinearSampler, kNoEdge},
     {kNoEdge},
    ...
    {Stage::CompositeTransmission,
     ...
     {Resource::SceneComposited, kNoEdge},
     {kNoEdge},
     kNoFusion},
    ...
    {Stage::AmbientOcclusion,
     ...
     PassKind::Raster,
     "ambientOcclusion",
     {Resource::SceneDepth, Resource::AtmosphereUniform, kNoEdge},
     {kNoEdge},
    ...
    {Stage::Overlay,
     ...
     PassKind::Raster,
     "overlay",
     {Resource::OverlayAtlas, Resource::LinearSampler, kNoEdge},
     {kNoEdge},
     {Resource::FrameTex, kNoEdge},
     kNoFusion},
    {Stage::Present,
     ...
     PassKind::Raster,
     "present",
     {Resource::FrameTex, Resource::LinearSampler, kNoEdge},
     {kNoEdge},
     {Resource::Surface, kNoEdge},
     kNoFusion},
};
