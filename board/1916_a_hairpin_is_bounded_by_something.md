...
the test measured different things (`src/generators/path/Alignment.cpp:159-160`). The corner bound is
...
**The refusal cites a number it did not use.** `src/generators/path/Alignment.cpp:172` prints
