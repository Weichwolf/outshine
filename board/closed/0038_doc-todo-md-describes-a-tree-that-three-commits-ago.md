...
| *"No Python in the engine or the tests … `verify_clients.py` remains"* | no Python outside `test/harness/shared/corpus/`, which is the offline preparation `CLAUDE.md` permits |
