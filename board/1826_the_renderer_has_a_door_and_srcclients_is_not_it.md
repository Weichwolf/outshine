...
`src/clients/GltfStudio.{h,cpp}` is the ONLY bridge from geometry to `Renderer`, and it holds
...
- [ ] `src/clients/` is dissolved: the public door stays, the scaffolding goes, and the three
