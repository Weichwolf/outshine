...
| import/ | Subject includes render Viewing/Framing; engine Asset retains Gltf::Document/Pose. Convert cameras/assets/animation at the boundary; remove import -> render edge per complete consumer. | 2150 |
