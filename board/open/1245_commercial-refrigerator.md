...
**CommercialRefrigerator has no case, and that is the whole of it**

*Commercial Refrigerator* -- tagged `extension`, `showcase` at the pin, published as `glTF`, `glTF-Binary`.
