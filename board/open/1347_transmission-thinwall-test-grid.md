...
**TransmissionThinwallTestGrid has no case, and that is the whole of it**

*TransmissionThinwallTestGrid* -- tagged `extension` at the pin, published as `glTF`, `glTF-Binary`.
