Type: feature
Area: corpus
Tags: khronos, extension, pbrtest

**CompareEmissiveStrength has no case, and that is the whole of it**

*Compare Emissive Strength* -- tagged `extension`, `pbrtest`, `testing` at the pin, published as `glTF`, `glTF-Binary`.
