...
**SciFiHelmet has a case and it is not green**

*SciFi Helmet* -- tagged `core`, `testing` at the pin, published as `glTF`.
...
|---|---|---|---|
| `test/khronos/glTF/SciFiHelmet` | met | outside | `picture_max_delta_code` |
