...
**XmpMetadataRoundedCube has no case, and that is the whole of it**

*Xmp Metadata Rounded Cube* -- tagged `extension`, `testing` at the pin, published as `glTF`, `glTF-Binary`.
