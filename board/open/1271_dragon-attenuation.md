...
**DragonAttenuation has no case, and that is the whole of it**

*Dragon Attenuation* -- tagged `extension` at the pin, published as `glTF`, `glTF-Binary`, `glTF-Meshopt`, `glTF-Meshopt-EXT`.
