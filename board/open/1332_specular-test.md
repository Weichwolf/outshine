Type: feature
Area: corpus
Tags: khronos, core, extension

**SpecularTest has a case and it is not green**

*Specular Test* -- tagged `core`, `extension`, `testing` at the pin, published as `glTF`, `glTF-Binary`.
...
|---|---|---|---|
| `test/khronos/glTF/SpecularTest` | red | outside | `worst_disagreement_px`, `picture_max_delta_code`, `linear_channels_differing` |
