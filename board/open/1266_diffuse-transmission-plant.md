...
**DiffuseTransmissionPlant has no case, and that is the whole of it**

*Diffuse Transmission Plant* -- tagged `extension`, `showcase` at the pin, published as `glTF`, `glTF-Binary`.
