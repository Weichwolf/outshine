...
**NormalTangentMirrorTest has a case and it is not green**

*Normal-Tangent Mirror Test* -- tagged `core`, `testing` at the pin, published as `glTF`, `glTF-Binary`.
...
|---|---|---|---|
| `test/khronos/glTF/NormalTangentMirrorTest` | met | outside | `picture_max_delta_code` |
