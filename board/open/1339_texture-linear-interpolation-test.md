...
**TextureLinearInterpolationTest has a case and it is not green**

*Texture Linear Interpolation Test* -- tagged `core`, `testing` at the pin, published as `glTF`, `glTF-Binary`.
...
|---|---|---|---|
| `test/khronos/glTF/TextureLinearInterpolationTest` | red | within | `linear_channels_differing` |
