...
**SheenWoodLeatherSofa has no case, and that is the whole of it**

*Sheen Wood Leather Sofa* -- tagged `extension`, `showcase` at the pin, published as `glTF`, `glTF-Binary`.
