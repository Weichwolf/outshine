...
**SunglassesKhronos has no case, and that is the whole of it**

*Sunglasses Khronos* -- tagged `extension`, `showcase` at the pin, published as `glTF`, `glTF-Binary`, `glTF-Draco`.
