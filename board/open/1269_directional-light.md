...
**DirectionalLight has a case and it is not green**

*Directional Light* -- tagged `core`, `testing` at the pin, published as `glTF`, `glTF-Binary`.
...
|---|---|---|---|
| `test/khronos/glTF/DirectionalLight` | met | outside | `picture_max_delta_code` |
