...
**ChronographWatch has no case, and that is the whole of it**

*Chronograph Watch* -- tagged `extension`, `showcase` at the pin, published as `glTF`, `glTF-Binary`, `glTF-KTX-BasisU`, `glTF-WEBP`.
