...
**AlphaBlendModeTest has a case and it is not green**

*Alpha Blend Mode Test* -- tagged `core`, `testing` at the pin, published as `glTF`, `glTF-Binary`.
...
|---|---|---|---|
| `test/khronos/glTF/AlphaBlendModeTest` | met | outside | `picture_max_delta_code` |
