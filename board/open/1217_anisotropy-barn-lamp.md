...
**AnisotropyBarnLamp has no case, and that is the whole of it**

*Anisotropy Barn Lamp* -- tagged `extension`, `showcase` at the pin, published as `glTF`, `glTF-Binary`, `glTF-KTX-BasisU`.
