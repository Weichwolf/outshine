...
**AnisotropyStrengthTest has no case, and that is the whole of it**

*Anisotropy Strength Test* -- tagged `extension`, `testing` at the pin, published as `glTF`, `glTF-Binary`.
