...
**CompareAlphaCoverage has no case, and that is the whole of it**

*Compare Alpha Coverage* -- tagged `core`, `pbrtest`, `testing` at the pin, published as `glTF`, `glTF-Binary`.
