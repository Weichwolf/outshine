...
**TransmissionOrderTest has no case, and that is the whole of it**

*Transmission Order Test* -- tagged `extension`, `testing` at the pin, published as `glTF`, `glTF-Binary`.
