Type: feature
Area: corpus
Tags: khronos, core, issues

**BoxTexturedNonPowerOfTwo has no case, and that is the whole of it**

*Box Textured not 2^N* -- tagged `core`, `issues`, `testing` at the pin, published as `glTF`, `glTF-Binary`, `glTF-Embedded`.
