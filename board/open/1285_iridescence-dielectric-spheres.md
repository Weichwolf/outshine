...
**IridescenceDielectricSpheres has no case, and that is the whole of it**

*Iridescence Dielectric Spheres* -- tagged `extension`, `testing` at the pin, published as `glTF`.
