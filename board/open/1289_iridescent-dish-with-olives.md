...
**IridescentDishWithOlives has no case, and that is the whole of it**

*Iridescent Dish with Olives* -- tagged `extension`, `showcase`, `video` at the pin, published as `glTF`, `glTF-Binary`.
