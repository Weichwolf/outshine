...
**MorphPrimitivesTest has no case, and that is the whole of it**

*Morph-Primitives Test* -- tagged `core`, `testing` at the pin, published as `glTF`, `glTF-Binary`, `glTF-Draco`.
