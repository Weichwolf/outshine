...
**CarConcept has no case, and that is the whole of it**

*Car Concept* -- tagged `extension`, `showcase` at the pin, published as `glTF`, `glTF-Binary`, `glTF-JPG`, `glTF-KTX-BasisU-Draco`, `glTF-WEBP`.
