...
**AnisotropyRotationTest has no case, and that is the whole of it**

*Anisotropy Rotation Test* -- tagged `extension`, `testing` at the pin, published as `glTF`, `glTF-Binary`.
