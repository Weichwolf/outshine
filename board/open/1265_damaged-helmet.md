...
**DamagedHelmet has no case, and that is the whole of it**

*Damaged Helmet* -- tagged `core`, `showcase`, `testing`, `video` at the pin, published as `glTF`, `glTF-Binary`, `glTF-Embedded`.
