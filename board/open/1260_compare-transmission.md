...
**CompareTransmission has no case, and that is the whole of it**

*Compare Transmission* -- tagged `extension`, `pbrtest`, `testing` at the pin, published as `glTF`, `glTF-Binary`.
