...
**TextureSettingsTest has a case and it is not green**

*Texture Settings Test* -- tagged `core`, `testing` at the pin, published as `glTF`, `glTF-Binary`, `glTF-Embedded`.
...
|---|---|---|---|
| `test/khronos/glTF/TextureSettingsTest` | met | outside | `picture_max_delta_code` |
