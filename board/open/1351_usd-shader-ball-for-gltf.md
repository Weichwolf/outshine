...
**USDShaderBallForGltf has no case, and that is the whole of it**

*USD Shader Ball for glTF* -- tagged `extension`, `showcase` at the pin, published as `glTF`, `glTF-Binary`.
