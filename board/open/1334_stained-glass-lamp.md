...
**StainedGlassLamp has no case, and that is the whole of it**

*Stained Glass Lamp* -- tagged `extension`, `showcase` at the pin, published as `glTF`, `glTF-JPG-PNG`, `glTF-KTX-BasisU`.
