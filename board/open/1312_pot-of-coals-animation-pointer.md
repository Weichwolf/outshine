...
**PotOfCoalsAnimationPointer has no case, and that is the whole of it**

*Pot of Coals Animation Pointer* -- tagged `extension`, `showcase` at the pin, published as `glTF`, `glTF-Binary`.
