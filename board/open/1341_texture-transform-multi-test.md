...
**TextureTransformMultiTest has no case, and that is the whole of it**

*Texture Transform Multi Test* -- tagged `extension`, `testing` at the pin, published as `glTF`, `glTF-Binary`.
