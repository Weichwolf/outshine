...
**CesiumMilkTruck has no case, and that is the whole of it**

*Cesium Milk Truck* -- tagged `core`, `issues`, `testing` at the pin, published as `glTF`, `glTF-Binary`, `glTF-Draco`, `glTF-Embedded`.
