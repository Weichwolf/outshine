...
**DiffuseTransmissionTeacup has no case, and that is the whole of it**

*Diffuse Transmission Teacup* -- tagged `extension`, `showcase` at the pin, published as `glTF`, `glTF-Binary`.
