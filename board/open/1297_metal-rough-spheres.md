...
**MetalRoughSpheres has no case, and that is the whole of it**

*Metal-Rough Spheres* -- tagged `core`, `testing` at the pin, published as `glTF`, `glTF-Binary`, `glTF-Embedded`.
