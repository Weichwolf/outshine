...
**TextureTransformTest has a case and it is not green**

*Texture Transform Test* -- tagged `extension`, `testing` at the pin, published as `glTF`.
...
|---|---|---|---|
| `test/khronos/glTF/TextureTransformTest` | met | outside | `picture_max_delta_code` |
