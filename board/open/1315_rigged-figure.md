...
**RiggedFigure has no case, and that is the whole of it**

*Rigged Figure* -- tagged `core`, `testing` at the pin, published as `glTF`, `glTF-Binary`, `glTF-Draco`, `glTF-Embedded`.
