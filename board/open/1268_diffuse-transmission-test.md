...
**DiffuseTransmissionTest has no case, and that is the whole of it**

*DiffuseTransmissionTest* -- tagged `extension`, `video`, `written` at the pin, published as `glTF`, `glTF-Binary`.
