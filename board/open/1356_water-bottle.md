...
**WaterBottle has a case and it is not green**

*Water Bottle* -- tagged `core`, `testing`, `written` at the pin, published as `glTF`, `glTF-Binary`, `glTF-Draco`.
...
|---|---|---|---|
| `test/khronos/glTF/WaterBottle` | met | outside | `picture_max_delta_code` |
