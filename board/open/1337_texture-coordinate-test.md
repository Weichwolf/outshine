...
**TextureCoordinateTest has a case and it is not green**

*Texture Coordinate Test* -- tagged `core`, `testing` at the pin, published as `glTF`, `glTF-Binary`, `glTF-Embedded`.
...
|---|---|---|---|
| `test/khronos/glTF/TextureCoordinateTest` | met | outside | `picture_max_delta_code` |
