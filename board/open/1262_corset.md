...
**Corset has a case and it is not green**

*Corset* -- tagged `core`, `testing` at the pin, published as `glTF`, `glTF-Binary`, `glTF-Draco`.
...
|---|---|---|---|
| `test/khronos/glTF/Corset` | met | outside | `picture_max_delta_code` |
