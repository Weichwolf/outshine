...
**Lantern has a case and it is not green**

*Lantern* -- tagged `core`, `testing` at the pin, published as `glTF`, `glTF-Binary`, `glTF-Draco`, `glTF-Quantized`.
...
|---|---|---|---|
| `test/khronos/glTF/Lantern` | met | outside | `picture_max_delta_code` |
