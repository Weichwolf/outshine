...
**BoxVertexColors has a case and it is not green**

*Box Vertex Colors* -- tagged `core`, `testing` at the pin, published as `glTF`, `glTF-Binary`, `glTF-Embedded`.
...
|---|---|---|---|
| `test/khronos/glTF/BoxVertexColors` | met | outside | `picture_max_delta_code` |
