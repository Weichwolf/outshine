Type: feature
Area: corpus
Tags: khronos, core, pbrtest

**CompareAmbientOcclusion has no case, and that is the whole of it**

*Compare Ambient Occlusion* -- tagged `core`, `pbrtest`, `testing` at the pin, published as `glTF`, `glTF-Binary`.
