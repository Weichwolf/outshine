...
**GlassHurricaneCandleHolder has no case, and that is the whole of it**

*Glass Hurricane Candle Holder* -- tagged `extension`, `showcase`, `video`, `written` at the pin, published as `glTF`, `glTF-Binary`.
