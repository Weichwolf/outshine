...
structural plausibility is checked against an explicitly declared simplified
load/support model, never advertised as real engineering certification.
...
| Building/support | floor, foundation and openings meet the declared support model; no unsupported overlap or false contact | load-path graph and contact/clearance predicates |
