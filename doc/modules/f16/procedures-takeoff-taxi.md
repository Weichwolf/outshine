...
|---|---|---|
| Takeoff roll, rotation, gear-up | **built** — pilot phase `Takeoff`, flies since `e49d335` | [`../../pilot.md`](../../pilot.md) |
| Vr-vs-weight table (128…198 kt over 20,000…44,000 lb) | **built** as `FBF16Pilot::RotationSpeedKt(gw)` — piecewise linear, clamped at the ends instead of extrapolated | [`module.md`](module.md) §3.1 |
...
| Ground handling: wheel brakes L/R, nosewheel steering, gear, speedbrake | **built** — `FBAirframeControls` / `FBJsbsimAirframeControls`; the pilot reaches the airframe only through this interface | [`../flightbox/sim/systems.md`](../../systems.md) §9 |
