...
pointing at it**. That is the doctrinal opposite of `doc/modules/f16/radar-sensors.md` and should drive an
...
**Doctrine consequence** (the direct counterpart to `doc/modules/f16/`'s BVR model): a MiG-29 `FBPilot`
