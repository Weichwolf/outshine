...
of the whole `doc/modules/mig29/` set and is distilled step-for-step below. **SHALLOW** on performance *tables*
...
> MiG-29, and the numbers differ substantially from `doc/modules/f16/procedures-*.md` — notably a **much
...
**Direct comparison with the F-16 baseline** (`doc/modules/f16/procedures-landing.md`): the F-16 flies its
