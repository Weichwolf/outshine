...
⚠️ **Compare the F-16** (`doc/modules/f16/hud-symbology.md`): TFOV 25° / IFOV 10.5°. The MiG-29's **IFOV is
...
1. **HUD symbol geometry** — no positions, sizes, spacings, tape scale intervals or clipping rules
   ...
   FlightBox MiG-29 HUD cannot be built to the standard of `doc/modules/f16/hud-symbology.md` from these
   sources. **This is the biggest single documentation gap in the whole `doc/modules/mig29/` set.**
