...
[`../sim/units-and-missions.md`](../sim/units-and-missions.md) (what a unit is and where its pose
comes from), [`../sim/weapons-and-damage.md`](../sim/weapons-and-damage.md) (what exists to be drawn).
...
|---|---|
| Where does a unit pose come from, and when is it safe to read | [`../sim/units-and-missions.md`](../sim/units-and-missions.md) (snapshot barrier) |
| What entities exist and what state they carry | [`../sim/units-and-missions.md`](../sim/units-and-missions.md), [`../sim/weapons-and-damage.md`](../sim/weapons-and-damage.md) |
| Which effects are already published as unit data | [`../sim/sensors.md`](../sim/sensors.md) (signature, chaff clouds) |
