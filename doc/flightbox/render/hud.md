...
[`../sim/systems.md`](../sim/systems.md) and [`../aircraft/f16.md`](../aircraft/f16.md). This file
...
#### 7.3 `FBHudFont` (`render/FBHudFont.h` + the generated `FBHudFontRom.h`)
...
`render/FBHudFont.h` stays generic; otherwise every future type would carry the F-16's chip around
with it.
