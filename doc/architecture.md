...
| `sim/src/core/` | avionics bus, command bus, log, telemetry, the two judges, mission-data types, damage model, ballistics, elevation hook, base types. **Never points into `systems/` or `modules/`.** | [core.md](core.md) |
