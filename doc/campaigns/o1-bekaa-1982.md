...
| **1 — re-run 2026-07-30 (`E6`)** | the same criterion after the judge-completion fix of [`../doctrine-evolution.md`](../doctrine-evolution.md) X-1 | **9 runs, 1 fingerprint** `629488cecfd3bc999213586dfb46487aedc2e13d117658991ab27eb67eed7361`, `--elev const`. **The rows above are kept with their dates; this is the current one.** Step exits `3 3 3 3 3 3 3 2 3 3` — unchanged. The fingerprint MOVED and **exactly one of the ten step fingerprints with it** — step 8 (`o1-08-belt-netted`), whose judge now publishes its objective vector after the run was cut short by a knockout; the other nine are byte-identical to the row above. |
| **2 — re-run 2026-07-30 (`E6`)** | every step re-run STANDALONE against the new reference tree | **10/10 MATCH**, exit codes included |
| Per-step fingerprints, 2026-07-30 (`E6`) | | `a8c61a98f8ae18a1 93196b527d3de44b 3b49587ef51eb174 61198c8e892c00d8 f9ed9b6116827fee 7e853c5cd5726c99 87df0a8d960b2a23 103be55af999d963 5280bba5d2b369e2 662fe96581c524e6` |
