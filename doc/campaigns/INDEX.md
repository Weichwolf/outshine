...
| **Jammer aircraft (EF-111 / Boeing 707 class)** | 2 | **no** | W3, O1 — in O1 it is the **decisive** mechanism of the whole battle |
...
| `C13` | **No jamming of any kind** — neither self-protection nor communications jamming | **1** (O1's mechanism) | 1 | the decisive Israeli move at Bekaa is the one thing in the set with no substitute at all |
...
| `C19` | **No rules-of-engagement state** — nothing expresses weapons hold / tight / free | **2** (W5, O2) | 0 | |
...
| The unit registry reaches exactly four files in `systems/`+`modules/`, all of them sensors | grep-checked, [`../sensors.md`](../sensors.md) | the pilot has no path to the truth even if it wanted one |
