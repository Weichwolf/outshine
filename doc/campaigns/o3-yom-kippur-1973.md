...
| **1 — re-run 2026-07-30 (`E6`)** | the same criterion after the judge-completion fix of [`../doctrine-evolution.md`](../doctrine-evolution.md) X-1 | **9 runs, 1 fingerprint** `e8e5dff2207a92d8ccc4e0ff142fa80ec1dd816528309f3d64d04986f6863782`, `--elev const`. **The rows above are kept with their dates; this is the current one.** Step exits `0 3 3 0 0 0 3 0 3 1` — unchanged. The fingerprint MOVED and **exactly one step fingerprint with it** — step 10 (`o3-10-october-six`), where `yxh` was shot combat-ineffective at t = 379.9 and hit the ground at t = 396.5, so its `UNIT_RESULT` now carries the MISSION judge's verdict instead of `CRASH` ([`../missions/runtime.md`](../missions/runtime.md) §5, `ShotDownFirst`). Exit codes and the campaign exit are unchanged. |
| **2 — re-run 2026-07-30 (`E6`)** | every step re-run STANDALONE against the new reference tree | **10/10 MATCH**, exit codes included |
| Per-step fingerprints, 2026-07-30 (`E6`) | | `cc5682956b788fc9 91e8fea172d46813 12edfcf6f8e45792 2beb4142c7a02e79 0397c8e6ce78a6ec fae132b551cd43d8 b8cc757093a225cb ea1d1ac898e38bf6 71f3375870fe5be8 6b5a410f0063ef1a` |
