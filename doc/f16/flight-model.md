...
**Warum diese Datei existiert.** `doc/f16/*.md` beschreibt den ECHTEN Jet aus den Handbüchern
(Design-Ziele). `doc/flightbox/*.md` beschreibt UNSEREN Code. CLAUDE.mds Prinzip 5 stützt die ganze
