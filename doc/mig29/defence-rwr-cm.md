...
detector + a threat library + a priority sorter (`doc/f16/defence-rwr-cm.md`), the SPO-15 is better
...
hemisphere threat. That is a *much* simpler model than `doc/f16/defence-rwr-cm.md` §2.2, and the
