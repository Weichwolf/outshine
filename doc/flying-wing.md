# FlightBox — Referenz-Hardware: Minimalistischer FPV-Nurflügel

*Das physische Referenzmodell, das der Simulator steuert und validiert (Use-Case 2 in
[`../README.md`](../README.md)). Bauspezifikation, nicht Simulator-Doku.*
