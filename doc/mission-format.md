...
|---|---|---|---|
| ungelenkt (`mk82`) | `sim/assets/aircraft/mk82` (Kopie des gepinnten Upstream) | `modules/stores/FBStoreModule` (alle Slots Default/NoOp) | integrieren, sonst nichts |
| gelenkt (`aim120`) | `sim/assets/aircraft/aim120` — FlightBox-EIGEN, das gepinnte Submodul hat keine AMRAAM | `modules/missile/FBMissileModule` (Sucher + Lenkung + Uplink-Empfänger) | Sucher erfasst, Lenkgesetz kommandiert die simulierten Ruder |
