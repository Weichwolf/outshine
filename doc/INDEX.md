...
| [campaigns/](campaigns/INDEX.md) | the **ten scenario specifications** — five flown by the F-16, five by the MiG-29, ten missions each, every anchor cited and tiered; plus the aggregated cast list, the capability gaps ordered by blocking degree, the identification task as an anti-cheat test and Bekaa as a measurable yardstick. **Six of ten BUILT AND FLOWN** (O4, O1, O5, O2, W5, W3 — sixty `.fbm` and six `.fbc`, every one with both determinism criteria measured) |
